var win_Alarmclock =  // описание элементов окна будильника
    `<div style="border: 2px double black;; background-color: #464451" id="AlarmclockCRM">
		...
		<div style="margin: 5px; width: 271px">
			...
			<input class="inputCRM" title="Ввод часа от 0 до 23 для напоминания" "="" id="setchasCRM" placeholder="HH" autocomplete="off" oninput="maxLengthCheck(this)" type="number" maxlength="2" min="0" max="23" style="text-align: center; margin-top: 5px; width: 50px; color: black;"> <class="spanCRM" style="color: white; margin-top: 5px;">:</span>
			...
			<input class="inputCRM" title="Ввод часа от 0 до 23 для напоминания" "="" id="setchasCRM1" placeholder="HH" autocomplete="off" oninput="maxLengthCheck(this)" type="number" maxlength="2" min="0" max="23" style="text-align: center; margin-top: 5px; width: 50px; color: black;"> <class="spanCRM" style="color: white; margin-top: 5px;">:</span>
